@extends('layouts.app', ['title' => __('Extras')])

@section('content')
    @include('users.partials.header', [
        'title' => __('Extras Management'),
        'class' => 'col-lg-7'
    ])
            ...
            <div class="col-xl-0 col-md-12 col-sm-12 order-xl-1">
              ...
              <div class="card-header text-right">
                <a href="{{ route('admin:categories.create') }}">
                  <button class="btn btn-sm btn-icon btn-primary" type="button">
                     ...
                     <span class="btn-inner--text">Add New Extra</span>
                  </button>
                </a>
              </div>
              ...
              <div class="container table-responsive py-4">
                <table class="table table-flush" id="datatable-buttons">
                  ...
                  @php
                    $i = $i + 1;
                    $edit_url = url('/admin/extra/edit/'.$value->id);
                    $delete_url = url('/admin/extra/destroy/'.$value->id);
                  @endphp
                    <tr>
